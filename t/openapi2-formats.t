...
sub validate_ok {
  ...
  my $descr
    = @expected
    ? "errors: @expected"
    : "valid: " . Mojo::JSON::encode_json($data);
...

{
  ...
  validate_ok {v => '2014-12-09T20:49:37Z'}, $schema;
  validate_ok {v => '0000-00-00T00:00:00Z'}, $schema,
    E('/v', 'Month out of range.');
  validate_ok {v => '0000-01-00T00:00:00Z'}, $schema,
    E('/v', 'Day out of range.');
  validate_ok {v => '20:46:02'}, $schema,
...

{
  ...
  validate_ok {v => 0.10000000000000}, $schema,
    E('/v', 'Does not match float format.');
}
...

{
  ...
  validate_ok {v => 2147483648},  $schema,
    E('/v', 'Does not match int32 format.');
}
...
if (JSON::Validator::OpenAPI::Mojolicious::IV_SIZE >= 8) {
  ...
  validate_ok {v => 9223372036854775808},  $schema,
    E('/v', 'Does not match int64 format.');
}
